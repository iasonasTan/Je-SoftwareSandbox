...
Copy-Item -Path "..\build\libs\Tier-List-1.0-SNAPSHOT.jar" -Destination "temp\app.jar"
...
Compress-Archive -Path "temp\*" -DestinationPath "..\generated\Tier-List-Windows.zip" -Force
