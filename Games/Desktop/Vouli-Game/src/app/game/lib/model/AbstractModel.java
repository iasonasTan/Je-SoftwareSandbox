...
public abstract class AbstractModel implements Model {
    ...
    private final Hitbox2 mHitbox = new Hitbox2();
    ...
    public AbstractModel(Context context) {
        ...
        mHitbox.size.set(new Size2(120, 120));
        if(context == null)
    ...
    @Override
    public Model setSize(Size2 size) {
    ...
    @Override
    public Size2 copySize() {
        return new Size2(mHitbox.size);
    }

    @Override
    public Hitbox2 copyHitbox() {
        return new Hitbox2(mHitbox);
    }
